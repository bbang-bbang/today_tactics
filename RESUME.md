...
- **브랜치/HEAD**: `main` `12ab462` (2026-06-12 세부포지션 비교필터). **origin push + 운영 git 동기화 완료**(로컬=origin=prod 일치 · 서비스 active · 헬스 200). 로컬 트리는 `checklist/history.md` 자동로그(마스킹 훅)로 수시 dirty(감사 로그 — 배포 무관).
...
- **정적 자산 최신 버전**: `k2heatmap.js?v=16` · `player_report.js?v=6` · `insights.js?v=38` · `workspace.js?v=6` · `style.css?v=84`. 변경 시 `templates/index.html`의 `?v=` 동반 증가 필수.
